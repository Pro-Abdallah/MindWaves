...
export const STORIES = [
  {
    ...
    label: 'Silence Inside a Heavy Heart — Living with Depression',
    bottleLabel: 'A Voice',
    tagline: 'Close your eyes. Listen.',
    description: 'A real voice, carried by the waves.',
    color: '#4A90C4',
    glowColor: 'rgba(74,144,196,0.6)',
    src: '/message_from_the_sea/1st_story/Message from the sea_Podcast (Asmaa).mov',
    subtitles: [
  ...
  },
  {
    ...
    label: 'Between the Waves — My Brother’s Battle with Schizophrenia',
    ...
    // placeholder — swap with real asset when ready
  ...
  },
  {
    ...
    label: 'The Boy Who Feared the Ocean — A Story of Autism',
    ...
    pages: [
      '/message_from_the_sea/3rd_story/0 - Cover.jpg',
      '/message_from_the_sea/3rd_story/1.jpg',
      '/message_from_the_sea/3rd_story/2.jpg',
      '/message_from_the_sea/3rd_story/3.jpg',
      '/message_from_the_sea/3rd_story/4.jpg',
      '/message_from_the_sea/3rd_story/5.jpg',
      '/message_from_the_sea/3rd_story/6.jpg',
      '/message_from_the_sea/3rd_story/7.jpg',
      '/message_from_the_sea/3rd_story/8.jpg',
      '/message_from_the_sea/3rd_story/9.jpg',
      '/message_from_the_sea/3rd_story/10.jpg',
      '/message_from_the_sea/3rd_story/11.jpg',
      '/message_from_the_sea/3rd_story/12.jpg',
      '/message_from_the_sea/3rd_story/13.jpg',
      '/message_from_the_sea/3rd_story/14.jpg',
      '/message_from_the_sea/3rd_story/15.jpg',
      '/message_from_the_sea/3rd_story/16.jpg',
      '/message_from_the_sea/3rd_story/17.jpg',
      '/message_from_the_sea/3rd_story/18.jpg',
      '/message_from_the_sea/3rd_story/19 - End Cover.jpg',
    ],
  },
  {
    id: 'text',
    ...
    label: 'My Story with Bipolar — A Journey Through the Stigma',
    ...
    image: '/message_from_the_sea/4th_story/WhatsApp Image 2026-05-19 at 4.28.03 PM.jpeg',
